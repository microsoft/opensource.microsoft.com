      ...
      <div className="pb-6">
        ...
        <ul className="ul mt-4">
          ...
          <li>
            ...
            Once your registration and review process is complete, make your GitHub repository public using the Settings pane on GitHub.
          </li>
          <li>
            <b>Going forward:</b>
            Ensure:
            <ul className="ul mt-4">
              ...
              <li>
                <strong>Staffing: </strong> Ensure at least one team member is committed to 
                managing community interactions merging pull requests, giving feedback, releasing new versions.
              </li>
              <li>
                <strong>Buildable & Runnable:</strong> Make sure that your project is easy to build and 
