...
export default function Overview() {
  return (
    <div className="pb-6">
      ...
      <p>
        Building on a foundation of <strong>eliminate</strong> (reducing complex and dated 
        policies for the modern engineering era), <strong>automate</strong> (detecting open
      ...
      <p>
        We <a href="https://cloudblogs.microsoft.com/opensource/2019/12/12/announcing-microsoft-openchain-conformance/" target="_new">
